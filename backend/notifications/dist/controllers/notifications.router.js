...
var _notifications = require("../models/notifications.model");
var _sampleNotifications = require("../utils/sampleNotifications");
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _notifications.NotificationsModel.countDocuments();
        case 2:
        ...
        case 6:
          _notifications.NotificationsModel.create(_sampleNotifications.sample_notifications).then(function (data) {
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _notifications.NotificationsModel.find();
        case 2:
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _notifications.NotificationsModel.deleteMany({});
        case 2:
          res.send({
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _notifications.NotificationsModel.findOne({
            id: req.query.id
          });
        case 2:
...
router.post('/newnotif', (0, _jwtVerify.jwtVerify)(['Manager', 'Technical', 'Functional', 'Admin']), (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          newNotification = new _notifications.NotificationsModel({
...
router.put('/changeToRead', (0, _jwtVerify.jwtVerify)(['Manager', 'Technical', 'Functional', 'Admin']), (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          ...
          _context6.prev = 2;
          _context6.next = 5;
          return _notifications.NotificationsModel.findOneAndUpdate({
...
router.put('/changeToUnread', (0, _jwtVerify.jwtVerify)(['Manager', 'Technical', 'Functional', 'Admin']), (0, _expressAsyncHandler["default"])( /*#__PURE__*/function () {
